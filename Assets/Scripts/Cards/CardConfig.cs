...
public class CardConfig
{
    public static List<CardData> s_PathCards = new List<CardData>
    {
        ...
        new CardData(CardTypes.PATH_CARD, "Left Corner Path", "Creates a Left Corner Path", null, null, new PathCardData(true, false, true, false, true)),
        new CardData(CardTypes.PATH_CARD, "Right Corner Path", "Creates a Right Corner Path", null, null, new PathCardData(true, false, false, true, true))
    };
